    ...
    private fun buildElement(element: Element, builder: SpannableStringBuilder): CharSequence {
        return builder.apply {
            when (element) {
                ...
                is Element.UnorderedListItem -> inSpans(
                    UnorderedListSpan(
                        gap,
                        bulletRadius,
                        colorSecondary
                ...
                is Element.Rule -> inSpans(HorizontalRuleSpan(ruleWidth, colorDivider)) {
                    append(element.text)
                }

                is Element.InlineCode -> inSpans(
                    InlineCodeSpan(
                        colorOnSurface,
                        colorSurface,
                        cornerRadius,
