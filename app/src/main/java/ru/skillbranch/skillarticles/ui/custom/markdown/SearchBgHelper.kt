...
class SearchBgHelper(
    ...
    private val singleLineRender by lazy {
        SingleLineRender(
            padding, drawable
        )
    }
    private val multilineRender by lazy {
        MultiLineRender(
    ...
    val drawableLeft = mockDrawableLeft ?: GradientDrawable().apply {
        shape = GradientDrawable.RECTANGLE
    ...
    val drawableMiddle = mockDrawableMiddle ?: GradientDrawable().apply {
        shape = GradientDrawable.RECTANGLE
        color = ColorStateList.valueOf(alphaColor)
        setStroke(borderWidth, secondaryColor)
    }
    ...
    val drawableRight = mockDrawableRight ?: GradientDrawable().apply {
        shape = GradientDrawable.RECTANGLE
        cornerRadii = floatArrayOf(
            radius, radius,
            0f, 0f,
